...
export default function Signup() {
    ...
    function setSignupFormError(field: AuthFormDataError) {
    ...
    async function submitUserCredentials(event: FormEvent<HTMLFormElement>) {
        ...
        setSignupFormError(DEFAULT_AUTH_FORM_DATA_ERROR);
                ...
                <div className="border border-gray-200 rounded-md p-6 flex flex-col gap-5 min-w-96 bg-white">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col">
                            ...
                            <input name="username" type="text" value={formsInput.username} onChange={(e) => { handleUsernameOnChange(e, setFormsInput, setSignupFormError) }} placeholder="Username" className="border border-gray-200 rounded-sm text-md font-light p-1" disabled={isSubmitting.form} />
                        ...
                        <div className="flex flex-col">
                            ...
                            <input name="email" type="email" value={formsInput.email} onChange={(e) => { handleEmailOnChange(e, setFormsInput, setSignupFormError) }} placeholder="Email" className="border border-gray-200 rounded-sm text-md font-light p-1" disabled={isSubmitting.form} />
                        ...
                        <div className="flex flex-col">
                            ...
                            <input name="password" type="password" value={formsInput.password} onChange={(e) => { handlepasswordOnChange(e, setFormsInput, setSignupFormError) }} placeholder="Password" className="border border-gray-200 rounded-sm text-md font-light p-1" disabled={isSubmitting.form} />
                            {error.password && <RequiredFieldError />}
                        </div>
                        <div className="flex gap-2">
                            <div> Already have an account? </div> <div onMouseDown={() => router.push("/login")} className="cursor-pointer text-blue-400">Log In here</div>
                        </div>
                    </div>
